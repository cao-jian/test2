function [resultVC,resultVE,rcomb,exchangeMap]=shake_doubleExchange(VC,VE,vehicle,rcomb,lenMax,exchangeMap)
% disp('doubleExchange')
...
while ~ f3  && count<100
    ...
    pos1=randperm(length(constRoute1),rem_len1);
    pos2=randperm(length(constRoute2),rem_len2);
    
    route1(pos1)=[];
    temp1=constRoute1(pos1);
    
    route2(pos2)=[];
    temp2=constRoute2(pos2);
